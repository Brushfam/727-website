        ...
        <div className={banner.banner} id='ComingSoon'>
            ...
            <div className={banner.textContent}>
                ...
                <div className={banner.rightside}>
                    ...
                    <p className='main'></p>
                    <p className='main'>We are focused on companies that change the landscape of the markets and ecosystems on both small and big scales,
                        those that drive the creation of web3, and those that are dedicated towards innovation done for people. </p>
                </div>
            </div>
